...
SELECT TOP(1) fpm.FaultTypeId, fpm.FaultTypeName, fpm.AssetClassificationId, fpm.AssetClassificationName, fpm.AssetSubTypeName, fpm.ResponsePriorityId FaultPriorityId, sr.SiteId, s.Name AS SiteName, r.Id, r.Name, stlm.LocationId, l.Name AS LocationName
