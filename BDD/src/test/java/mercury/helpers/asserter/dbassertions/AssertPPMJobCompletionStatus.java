...
public class AssertPPMJobCompletionStatus implements AssertTask {
    ...
    public AssertPPMJobCompletionStatus(PPMJobDao PPMJobDao, Integer jobReference, String jobStatus) {
    ...
    public boolean execute() {
        try {
            String actual = PPMJobDao.getPPMJobCompletionStatusByPpmId(jobReference).getStatus();
