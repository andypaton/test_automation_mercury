...
public class HelpdeskAssetPage extends Base_Page<HelpdeskAssetPage> {
    ...
    private static final String ACTIVE_WORKSPACE_CSS = "#main-panel > div.tab-content > div.tab-pane.active div.view.asset";
    protected static final String ACTIVE_WORKSPACE_XPATH = "//div[contains(@class,'tab-pane') and contains(@class,'active')]//div[@class='view asset']";
	...
	public HelpdeskAssetPage(WebDriver driver) {
		super(driver);
	}
