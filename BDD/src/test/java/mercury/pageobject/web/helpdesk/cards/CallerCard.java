...
public class CallerCard extends Base_Page<CallerCard> {

	private static final Logger logger = LogManager.getLogger();
	
    private static final String CALLER_CARD_XPATH = "//div[@id='side-panel']//div[@class='card caller']";
    
    private static final String CARD_HEADER_XPATH = CALLER_CARD_XPATH + "//div[@class='card-header']";
    private static final String CARD_HEADER_ICON_XPATH = CALLER_CARD_XPATH + "//div[@class='card-header__icon-container']";

    private static final String CARD_SUBHEADER_LEFT_XPATH =CALLER_CARD_XPATH +  "//div[@class='card-subheader__left']";
    private static final String CARD_SUBHEADER_RIGHT_XPATH = CALLER_CARD_XPATH + "//div[@class='card-subheader__right']";
    private static final String CARD_CONTENT_XPATH = CALLER_CARD_XPATH + "//div[@class='card-content']";
    
    private static final String WRENCH_XPATH = CALLER_CARD_XPATH + "//i[@class='icons__wrench']/..";
    private static final String EXCLAMATION_TRIANGLE_XPATH = CALLER_CARD_XPATH + "//i[@class='icons__exclamation-triangle']/..";
        
    @FindBy(xpath=CALLER_CARD_XPATH)
	...
	public CallerCard(WebDriver driver) {
		super(driver);
	}
	...
	protected void isLoaded() throws Error {	
		try {			
			Assert.assertTrue("Page is not displayed", driver.findElement(By.xpath(CALLER_CARD_XPATH)).isDisplayed());
	...
	public boolean isCardDisplayed() throws Exception {
		return isElementPresent(By.xpath(CALLER_CARD_XPATH));
	}
