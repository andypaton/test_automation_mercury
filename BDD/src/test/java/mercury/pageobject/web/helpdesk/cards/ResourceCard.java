...
public class ResourceCard extends Base_Page<ResourceCard> {

    private static final Logger logger = LogManager.getLogger();

    private static final String VISIBLE_SIDE_PANEL_XPATH = "//div[@id='side-panel']";

    private static final String RESOURCE_CARD_XPATH = VISIBLE_SIDE_PANEL_XPATH + "//div[@class='card resource']";

    private static final String CARD_HEADER_XPATH = RESOURCE_CARD_XPATH + "//div[@class='card-header']";
    private static final String CARD_HEADER_ICON_XPATH = RESOURCE_CARD_XPATH + "//div[@class='card-header__icon-container']";

    private static final String CARD_SUBHEADER_LEFT_XPATH =RESOURCE_CARD_XPATH +  "//div[@class='card-subheader__left']";
    private static final String CARD_SUBHEADER_RIGHT_XPATH = RESOURCE_CARD_XPATH + "//div[@class='card-subheader__right']";
    private static final String CARD_CONTENT_XPATH = RESOURCE_CARD_XPATH + "//div[@class='card-content']";
    ...
    @FindBy(xpath=RESOURCE_CARD_XPATH)
    ...
    public ResourceCard(WebDriver driver) {
        super(driver);
    }
    ...
    protected void isLoaded() throws Error {
        try {
            Assert.assertTrue("Page is not displayed", driver.findElement(By.xpath(RESOURCE_CARD_XPATH)).isDisplayed());
    ...
    public boolean isCardDisplayed() throws Exception {
        return isElementPresent(By.xpath(RESOURCE_CARD_XPATH));
    }
