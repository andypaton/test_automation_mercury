...
public class FundingRequestsRejectedPage extends Base_Page<FundingRequestsRejectedPage>{

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Quotes With Funding Request Rejected";
    ...
    // Page methods
    public FundingRequestsRejectedPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public FundingRequestsRejectedPage searchJobs(String searchQuery) {
        waitForAnimation();
    ...
    public boolean isQuoteDisplayed(String jobReference) {
        return isElementPresent(By.xpath(String.format(TABLE_ROW_JOB_XPATH, jobReference)));
    }

    public FundingRequestsRejectedPage tableSort(String header, boolean isAscending) {
        scrollTo(0);
