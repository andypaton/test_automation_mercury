...
public class PortalAppliancePartial extends Base_Page<PortalAppliancePartial> {

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "US Gas Regulations Appliance Questions Partial";
    ...
    private static final String US_GAS_APPLIANCE_QUESTIONS_FORM_XPATH = US_GAS_REGULATIONS_XPATH + "//us-gas-appliance-questions";

    @Override
    protected void isLoaded() throws Error {
        logger.info(PAGE_TITLE + " isloaded");
        try {
            POHelper.isLoaded().isFluentElementIsVisible(By.xpath(US_GAS_APPLIANCE_QUESTIONS_FORM_XPATH));
    ...
    public PortalAppliancePartial(WebDriver driver) {
        super(driver);
    ...
    public QuestionHelper getQuestionHelper() {
        ...
        questionHelper.load(US_GAS_APPLIANCE_QUESTIONS_FORM_XPATH);
