...
public class FundingRequestsPendingQueryResponsePage extends Base_Page<FundingRequestsPendingQueryResponsePage> {

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Funding Requests Pending Query Response";
    ...
    private static final String GRID_ROW_CLICKABLE_XPATH = GRID_XPATH + "//tr[contains(@class, 'qas-can-click')]";
    ...
    // Page methods
    public FundingRequestsPendingQueryResponsePage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public FundingRequestsPendingQueryResponsePage searchJobs(String searchQuery) {
    ...
    public FundingRequestsAwaitingApprovalPage openFundingRequestAwaitingResponseReview(String jobReference) throws InterruptedException {
    ...
    public FundingRequestsPendingQueryResponsePage tableSort(String header, boolean isAscending) {
        scrollTo(0);
    ...
    public boolean isGridInteractive() {
        return isElementPresent(By.xpath(GRID_ROW_CLICKABLE_XPATH));
    }
}
