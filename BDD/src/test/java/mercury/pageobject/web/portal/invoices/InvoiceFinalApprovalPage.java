...
public class InvoiceFinalApprovalPage extends Base_Page<InvoiceFinalApprovalPage>{
    private static final Logger logger = LogManager.getLogger();
    // Page title
    private static final String PAGE_TITLE = "Invoice Final Approval";
    ...
    private static final String INVOICE_DOCUMENTS_CHECK_LIST_XPATH = INVOICE_APPROVAL_CONTAINER_XPATH + "//ul[contains(@class,'doc-menu')]//li";
    private static final String INVOICE_DOCUMENTS_CHECKED_XPATH = INVOICE_DOCUMENTS_CHECK_LIST_XPATH + "[contains(@class, 'doc-checked current')]";
    ...
    // Buttons
    private static final String INVOICE_REJECT_BUTTON_XPATH = INVOICE_APPROVAL_CONTAINER_XPATH + "//input[@id='RejectInvoice']";
    private static final String INVOICE_VIEW_INVOICE_LINES_BUTTON_XPATH = INVOICE_APPROVAL_CONTAINER_XPATH + "//input[@id='ViewInvoiceLines']";
    ...
    public InvoiceFinalApprovalPage(WebDriver driver) {
        super(driver);
    }
    ...
    public ApproveInvoiceModalPage approve() {
        invoiceApproveButton.click();
        waitForAngularRequestsToFinish();
        return PageFactory.initElements(driver, ApproveInvoiceModalPage.class).get();
    }
