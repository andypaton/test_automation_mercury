...
public class MultiQuoteAwaitingResourceSelectionPage extends Base_Page<MultiQuoteAwaitingResourceSelectionPage>{
    //update others based on this
    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Multi-Quotes Awaiting Resource Selection";
    ...
    //btn btn-xs btn-primary edit-quote-job
    ...
    // Page methods
    public MultiQuoteAwaitingResourceSelectionPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public MultiQuoteAwaitingResourceSelectionPage searchJobs(String searchQuery) {
