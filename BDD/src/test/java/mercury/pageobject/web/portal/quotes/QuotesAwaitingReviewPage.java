...
public class QuotesAwaitingReviewPage extends Base_Page<QuotesAwaitingReviewPage> {

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Quotes Awaiting Review";
    ...
    private static final String TABLE_ROW_JOB_LINK_XPATH = PAGE_BODY_CONTENT_XPATH + "/descendant::tr[contains(@data-fault-id,'%s') and contains(@class,'qas-can-click')]";
    ...
    // Page methods
    public QuotesAwaitingReviewPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public QuotesAwaitingReviewPage searchJobs(String searchQuery) {
    ...
    public QuotesManagersDecisionPage OpenJob(String jobReference) throws InterruptedException {
        //Raised MTA-138 to remove sleep
        waitForAnimation();
    ...
    public QuotesAwaitingReviewPage tableSort(String header, boolean isAscending) {
        scrollTo(0);
