...
public class MultiQuoteAwaitingReviewPage extends Base_Page<MultiQuoteAwaitingReviewPage>{

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Multi-Quotes Awaiting Review";
    ...
    // Page methods
    public MultiQuoteAwaitingReviewPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public MultiQuoteAwaitingReviewPage searchJobs(String searchQuery) {
    ...
    public QuotesManagersDecisionPage reviewQuoteJobRequest(Integer jobReference) {
    ...
    public MultiQuoteAwaitingReviewPage tableSort(String header, boolean isAscending) {
        scrollTo(0);
