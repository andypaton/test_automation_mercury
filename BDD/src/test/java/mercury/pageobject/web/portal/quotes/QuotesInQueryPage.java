...
public class QuotesInQueryPage extends Base_Page<QuotesInQueryPage>{

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Quotes in Query";
    ...
    private static final String GRID_XPATH = PAGE_MAIN_CONTENT_XPATH + "//div[@id='quotes-query-pending_wrapper']";
    private static final String GRID_CSS = "#quotes-query-pending_wrapper";
    private static final String GRID_FILTER_CSS  = GRID_CSS + " #quotes-query-pending_filter";
    ...
    // Page methods
    public QuotesInQueryPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public QuotesInQueryPage searchJobs(String searchQuery) {
