...
public class PartsRequestsAwaitingApprovalPage extends Base_Page<PartsRequestsAwaitingApprovalPage>{

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Parts Requests Awaiting Approval";
    ...
    // Page methods
    public PartsRequestsAwaitingApprovalPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public PartsRequestsAwaitingApprovalPage searchJobs(String searchQuery) {
    ...
    public PartsOrderAwaitingApprovalPage OpenJob(String jobReference) throws InterruptedException {
        ...
        waitForAnimation();
        return PageFactory.initElements(driver, PartsOrderAwaitingApprovalPage.class).get();
    }
    ...
    public boolean isJobDisplayed(String jobReference) {
        return isElementPresent(By.xpath(String.format(TABLE_ROW_TYPE_XPATH_SUFFIX, jobReference)));
    }

    public PartsRequestsAwaitingApprovalPage tableSort(String header, boolean isAscending) {
        scrollTo(0);
