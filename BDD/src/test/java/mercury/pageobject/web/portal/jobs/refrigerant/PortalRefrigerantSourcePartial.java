...
public class PortalRefrigerantSourcePartial extends Base_Page<PortalRefrigerantSourcePartial> {
    ...
    private static final String US_GAS_QUESTIONS_FORM_XPATH = US_GAS_REGULATIONS_XPATH + "//us-gas-refrigerant-source-questions";

    private static final String ADD_REFRIGERANT_SOURCE_XPATH = US_GAS_QUESTIONS_FORM_XPATH + "//div[contains(@class, 'btn-primary')]//i[contains(@class, 'icons__plus')]";

    private static final String REFRIGERANT_SOURCE_GRID_XPATH = "//us-gas-refrigerant-source-questions";
    private static final String REFRIGERANT_SOURCE_GRID_HEADERS_CSS = "div.gas-section__gas-source-header-row div";

    @FindBy(xpath = ADD_REFRIGERANT_SOURCE_XPATH)
    private WebElement addRefrigerantSource;
    ...
    public PortalRefrigerantSourcePartial(WebDriver driver) {
        super(driver);
        // TODO Auto-generated constructor stub
    }

    public void addRefrigerantSource() {
        addRefrigerantSource.click();
        waitForAngularRequestsToFinish();
    }

    public Grid getGasGrid() {
        return GridHelper.getDivGrid(REFRIGERANT_SOURCE_GRID_XPATH, REFRIGERANT_SOURCE_GRID_HEADERS_CSS);
    }
}
