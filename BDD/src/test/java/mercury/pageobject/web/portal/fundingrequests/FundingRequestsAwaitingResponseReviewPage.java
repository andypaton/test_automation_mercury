...
public class FundingRequestsAwaitingResponseReviewPage extends Base_Page<FundingRequestsAwaitingResponseReviewPage> {

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Funding Requests Awaiting Response Review";
    ...
    // Page methods
    public FundingRequestsAwaitingResponseReviewPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public FundingRequestsAwaitingResponseReviewPage searchJobs(String searchQuery) {
    ...
    public FundingRequestsAwaitingResponseReviewPage tableSort(String header, boolean isAscending) {
        scrollTo(0);
