...
public class MultiQuoteAwaitingBypassApprovalPage extends Base_Page<MultiQuoteAwaitingBypassApprovalPage>{

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Multi Quotes Awaiting Bypass Approval";
    ...
    // Page methods
    public MultiQuoteAwaitingBypassApprovalPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public MultiQuoteAwaitingBypassApprovalPage searchJobs(String searchQuery) {
