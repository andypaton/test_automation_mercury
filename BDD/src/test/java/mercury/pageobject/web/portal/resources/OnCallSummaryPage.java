...
public class OnCallSummaryPage extends Base_Page<OnCallSummaryPage> {

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "On Call Summary";
    ...
    // Page methods
    public OnCallSummaryPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public OnCallSummaryPage searchJobs(String searchQuery) {
        waitForAnimation();
    ...
    public OnCallSummaryPage tableSort(String header, boolean isAscending) {
        scrollTo(0);
