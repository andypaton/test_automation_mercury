...
public class JobsAwaitingResourceSelectionPage extends Base_Page<JobsAwaitingResourceSelectionPage>{

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Jobs Awaiting Resource Selection";
    ...
    private static final String TABLE_ROW_JOB_EDIT_QUOTE_BUTTON = TABLE_ROW_JOB_XPATH + "//a[contains(text(), 'Edit Quote Job')]";
    ...
    public JobsAwaitingResourceSelectionPage(WebDriver driver) {
        super(driver);
    ...
    protected void isLoaded() throws Error {
        ...
        try {
            ...
            POHelper.isLoaded().isFluentElementIsVisible(By.xpath(PAGE_MAIN_CONTENT_XPATH));
    ...
    // Page Interactions
    public JobsAwaitingResourceSelectionPage searchJobs(String searchQuery) {
    ...
    public JobsAwaitingResourceSelectionPage tableSort(String header, boolean isAscending) {
        scrollTo(0);
