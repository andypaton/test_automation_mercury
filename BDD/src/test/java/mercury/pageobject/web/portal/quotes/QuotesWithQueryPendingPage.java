...
public class QuotesWithQueryPendingPage extends Base_Page<QuotesWithQueryPendingPage>{

    private static final Logger logger = LogManager.getLogger();

    // Page title
    private static final String PAGE_TITLE = "Quotes With Query Pending";
    ...
    private static final String GRID_CSS = PAGE_MAIN_CONTENT + " #quote-query-pending_wrapper";
    private static final String GRID_FILTER_CSS  = GRID_CSS + " #quote-query-pending_filter";
    ...
    // Page methods
    public QuotesWithQueryPendingPage(WebDriver driver) {
        super(driver);
    ...
    // Page Interactions
    public QuotesWithQueryPendingPage searchJobs(String searchQuery) {
    ...
    public QuoteQueryPage OpenJob(String jobReference) throws InterruptedException {
        waitForAnimation();
