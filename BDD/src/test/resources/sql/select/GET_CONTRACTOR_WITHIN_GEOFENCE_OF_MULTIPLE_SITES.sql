...
WHERE GEOGRAPHY::Point(s1.Location.Lat, s1.Location.Long, 4326).STDistance(GEOGRAPHY::Point(s2.Location.Lat, s2.Location.Long, 4326)) < 750
AND cs1.ResourceId = cs2.ResourceId
AND s1.Active = 1 